 ...
 * Copyright (c) 2009-2011 by iWanted, Inc. All Rights Reserved.
...
//@interface iWantedObject : NSObject
//@end

@interface iWantedObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[iWantedObject class]])
		{
			for (NSString *key in [[(iWantedObject*)o modules] allKeys])
			{
