...
// in simulator we redefine to format for iWanted Developer console
...
{\
	NSString * exceptionName = [@"org.iwanted." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.iwanted";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	TiExceptionThrowWithNameAndReason(exceptionName,message);\
}\
...
enum {
	UIiWantedNativeItemNone = -1, 
	UIiWantedNativeItemSpinner = -2,
	UIiWantedNativeItemProgressBar = -3,
	
	UIiWantedNativeItemSlider = -4,
	UIiWantedNativeItemSwitch = -5,
	UIiWantedNativeItemMultiButton = -6,
	UIiWantedNativeItemSegmented = -7,
	
	UIiWantedNativeItemTextView = -8,
	UIiWantedNativeItemTextField = -9,
	UIiWantedNativeItemSearchBar = -10,
	
	UIiWantedNativeItemPicker = -11,
	UIiWantedNativeItemDatePicker = -12,
	
	UIiWantedNativeItemInfoLight = -13,
	UIiWantedNativeItemInfoDark = -14,
	
	UIiWantedNativeItemDisclosure = -15,
	
	UIiWantedNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all iWanted instances of
