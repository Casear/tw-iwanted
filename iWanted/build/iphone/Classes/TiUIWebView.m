...
static NSString * const kiWantedJavascript = @"Ti.App={};Ti.API={};Ti.App._listeners={};Ti.App._listener_id=1;Ti.App.id=Ti.appId;Ti.App._xhr=XMLHttpRequest;"
...
-(NSString*)_iwantedInjection
{
	...
	[html appendString:kiWantedJavascript];
...
{
	// attempt to make well-formed HTML and inject in our iWanted bridge code
	...
	if (range.location!=NSNotFound)
	{
		...
		if (nextRange.location!=NSNotFound)
		{
			...
			[html appendString:[self _iwantedInjection]];
